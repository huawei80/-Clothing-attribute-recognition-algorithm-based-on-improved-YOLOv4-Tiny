...
class YOLO(object):
    _defaults = {
        "model_path"        : r'logs\Epoch11-Total_Loss4.3110-Val_Loss3.4405.pth',
    ...
    def detect_image(self, image):
        ...
        font = ImageFont.truetype(font='model_data/simhei.ttf',size=np.floor(0.085 * np.shape(image)[1]).astype('int32'))
