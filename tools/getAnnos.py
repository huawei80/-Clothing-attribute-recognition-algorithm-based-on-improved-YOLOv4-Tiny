...
# 所有路径
def All_path():
    json_path = r"E:\BaiduNetdiskDownload\datasets\train\annos"
    img_path = r"E:\BaiduNetdiskDownload\datasets\validation\validation\image"
    save_path = r"E:\BaiduNetdiskDownload\datasets\validation\validation\input\ground-truth"
