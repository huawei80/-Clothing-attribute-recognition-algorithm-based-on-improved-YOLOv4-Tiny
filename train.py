...
if __name__ == "__main__":
    ...
    classes_path = r'deep2/classes.txt'
    #----------------------------------------------------#
    #   获取classes和anchor
    #----------------------------------------------------#
    ...
    #   权值文件请看README，百度网盘下载
    #------------------------------------------------------#
    model_path = r"E:\Work projects\sky\yolov4-tiny-pytorch-master\yolov4-tiny-pytorch-master\logs\Epoch11-Total_Loss4.3110-Val_Loss3.4405.pth"
    # 加快模型训练的效率
    ...
    #   获得图片路径和标签
    #----------------------------------------------------#
    annotation_path =r'E:\my\data/train191961.txt'
    #----------------------------------------------------------------------#
